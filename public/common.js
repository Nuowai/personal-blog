(function () {
  const dictionaries = {
    'zh-CN': {
      ...
      'ai.title': 'AI 小助手', 'ai.subtitle': '支持 OpenAI 兼容接口', 'ai.provider': '供应商', 'ai.baseUrl': 'OpenAI 兼容 Base URL', 'ai.apiKey': 'API Key（仅保存在本机）', 'ai.model': '模型', 'ai.context': '会携带最近 24 条消息作为上下文，Key 和历史只保存在本机。', 'ai.clear': '清空对话', 'ai.welcome': '填好 API Key 和 Base URL 后，就可以开始聊天啦 ✨', 'ai.placeholder': '和小助手说点什么…',
      'ai.noKey': '先填入你的 AI API Key 哦～',
      'ai.thinking': '正在思考中…',
      ...
      'location.scriptFailed': '地图脚本加载失败',
      'weather.loading': '天气信息加载中…',
      'weather.failed': '天气查询失败',
      'weather.notConfigured': '站点未配置天气服务',
      'errors.ADMIN_NOT_CONFIGURED': '管理员尚未配置',
      'errors.ADMIN_UNAUTHORIZED': '管理员密钥不正确',
      'errors.AI_KEY_REQUIRED': '请先填写 AI API Key',
      'errors.AI_MODEL_REQUIRED': '请填写 AI 模型名称',
      'errors.AI_MESSAGES_REQUIRED': '消息不能为空',
      'errors.AI_INVALID_MESSAGE': '消息格式不正确',
      'errors.AI_INVALID_BASE_URL': 'AI Base URL 格式或地址不安全',
      'errors.AI_CONTEXT_TOO_LARGE': '对话上下文过长，请清理历史后重试',
      'errors.AI_UPSTREAM_ERROR': 'AI 供应商暂时不可用',
      'errors.DEEPSEEK_KEY_REQUIRED': '请先填写 AI API Key',
      ...
      'errors.INVALID_TYPE': '字段类型不正确',
      'admin.published': '已发布',
      'admin.draft': '草稿',
      'admin.edit': '编辑',
      'admin.delete': '删',
      'admin.emptyPosts': '文章抽屉还是空的～',
    ...
    en: {
      ...
      'ai.title': 'AI assistant', 'ai.subtitle': 'Any OpenAI-compatible API', 'ai.provider': 'Provider', 'ai.baseUrl': 'OpenAI-compatible Base URL', 'ai.apiKey': 'API key (stored only on this device)', 'ai.model': 'Model', 'ai.context': 'The latest 24 messages are sent as context. Key and history stay on this device.', 'ai.clear': 'Clear chat', 'ai.welcome': 'Add an API key and Base URL to start chatting ✨', 'ai.placeholder': 'Say something to the assistant…',
      'ai.noKey': 'Add your AI API key first.',
      ...
      'location.scriptFailed': 'The map script failed to load.',
      'weather.loading': 'Loading weather…',
      'weather.failed': 'Weather lookup failed.',
      ...
      'errors.AI_KEY_REQUIRED': 'Enter an AI API key first.',
      'errors.AI_MODEL_REQUIRED': 'Enter an AI model name.',
      'errors.AI_MESSAGES_REQUIRED': 'Message content is required.',
      'errors.AI_INVALID_MESSAGE': 'The message format is invalid.',
      'errors.AI_INVALID_BASE_URL': 'The AI Base URL is invalid or unsafe.',
      'errors.AI_CONTEXT_TOO_LARGE': 'The conversation is too long. Clear the history and try again.',
      'errors.AI_UPSTREAM_ERROR': 'The AI provider is temporarily unavailable.',
      'errors.DEEPSEEK_KEY_REQUIRED': 'Enter an AI API key first.',
      ...
      'errors.INVALID_TYPE': 'The field type is invalid.',
      'admin.published': 'Published',
      'admin.draft': 'Draft',
      'admin.edit': 'Edit',
      'admin.delete': 'Delete',
      'admin.emptyPosts': 'No posts yet.',
      'admin.emptyMedia': 'No media uploaded yet.',
      'admin.chooseFile': 'Choose a file first.',
      'admin.confirmDeleteMedia': 'Delete “{name}”?',
      'admin.confirmDeletePost': 'Delete “{name}”?',
